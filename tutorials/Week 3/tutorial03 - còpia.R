...
#We're gonna learn how to create own likelihood function, run our own GLM in MLE...
#Knowing MLE makes us not trust glm models blindly.
...
setwd("C:/Users/Usuario/Documents/GitHub/StatsII_2026/tutorials/Week 3")
