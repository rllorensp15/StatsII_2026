...
\begin{document}
	...
	\begin{frame}{The Original Study: Research Question}
		\begin{itemize}
			...
			\end{enumerate}
			\item \textbf{Mechanism:} Brexit as a "priming" factor that reactivates memories of political and economic instability.
		\end{itemize}
	\end{frame}
	...
	\begin{frame}{Replication: Constitutional Preferences (Fig 2 \& 3)}
		...
		\end{itemize}
		\begin{center}
			\includegraphics[width=0.7\textwidth]{Fig3.jpeg}
		\end{center}
	\end{frame}
	...
	\begin{frame}{Conclusions}
		\begin{itemize}
			...
			\item \textbf{Contribution:} I show that the effect is not socially neutral:
			\begin{itemize}
				\item It is \textbf{gendered} (stronger in men).
				\item It is \textbf{trauma-sensitive} (stronger in victims).
				\item It is \textbf{generationally homogeneous} in its reaction.
			\end{itemize}
		\end{itemize}
	\end{frame}
